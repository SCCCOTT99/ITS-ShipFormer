...
def resnet18(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["resnet18"], model_dir="./model_data", progress=progress)
...
def resnet34(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["resnet34"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict)
...
def resnet101(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["resnet101"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict)
...
def resnet152(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["resnet152"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict)
