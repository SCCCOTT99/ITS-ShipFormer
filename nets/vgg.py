...
def vgg11(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg11"], model_dir="./model_data", progress=progress)
...
def vgg13(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg13"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict, strict=False)
...
def vgg16(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg16"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict, strict=False)
...
def vgg11_bn(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg11_bn"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict, strict=False)
...
def vgg13_bn(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg13_bn"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict, strict=False)
...
def vgg16_bn(pretrained=False, progress=True, num_classes=1000):
    ...
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls["vgg16_bn"], model_dir="./model_data", progress=progress)
        model.load_state_dict(state_dict, strict=False)
